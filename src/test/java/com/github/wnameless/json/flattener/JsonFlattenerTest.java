...
public class JsonFlattenerTest {
    ...
    @Test
    public void testFlattenWithFlattenModeGroupArray() throws IOException {
        URL urlInput = Resources.getResource("test_group_array_input.json");
        String jsonInput = Resources.toString(urlInput, Charsets.UTF_8);

        URL urlExpected = Resources.getResource("test_group_array_expected.json");
        String jsonExpected = Resources.toString(urlInput, Charsets.UTF_8);

        String actualJson = new JsonFlattener(jsonInput)
                .withPrintMode(PrintMode.PRETTY)
                .withFlattenMode(FlattenMode.GROUP_ARRAY_ATTRIBUTES)
                .withLeftAndRightBrackets("_", "")
                .withSeparator("__")
                .flatten();
